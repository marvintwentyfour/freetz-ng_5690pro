$(call PKG_INIT_BIN, $(if $(FREETZ_GDB_VERSION_6_8),6.8,$(if $(FREETZ_GDB_VERSION_7_9),7.9.1,16.3)))
...
$(PKG)_HASH_16.3  :=bcfcd095528a987917acf9fff3f1672181694926cc18d609c99d0042c00224c5
...
$(PKG)_REBUILD_SUBOPTS += FREETZ_GDB_VERSION_16_3

$(PKG)_CONFIGURE_ENV += CFLAGS_FOR_TARGET="$(TARGET_CFLAGS) -Wno-psabi"
...
$(PKG)_CONFIGURE_OPTIONS += --enable-static --with-static-standard-libraries --disable-inprocess-agent
